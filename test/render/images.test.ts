...
describe('an image the layout result places', () => {
  it('paints an img at the engine object box in engine coordinates', async () => {
    ...
    const box = imageBoxOf(found.run.object ?? { objectId: '', children: [], relationshipId: undefined, width: mp(0), height: mp(0), crop: undefined, rotationMilliDegrees: 0, anchor: undefined }, paintScale(1));
