...
.docier-chrome-menubar{display:flex;grid-area:menubar;align-items:stretch;flex-wrap:nowrap;background:var(--docier-surface-raised);border-bottom:1px solid var(--docier-border);position:relative;z-index:12}
...
.docier-ribbon{display:flex;grid-area:ribbon;overflow:hidden;container-type:inline-size;background:var(--docier-surface);border-bottom:1px solid var(--docier-border);min-height:0}
...
.docier-group{display:flex;flex:1 1 auto;flex-direction:column;justify-content:space-between;min-width:min-content;border-inline-end:1px solid var(--docier-border);padding-inline-end:calc(var(--docier-gap) * 2)}
...
.docier-group-label{display:flex;align-items:center;justify-content:center;gap:var(--docier-gap);color:var(--docier-text-muted);font-size:calc(var(--docier-ui-font-size) - 2px);padding-block-start:2px;text-align:center}
...
.docier-ruler{position:relative;grid-area:ruler;height:var(--docier-ruler-size);background:var(--docier-surface-raised);border-bottom:1px solid var(--docier-border);overflow:hidden;user-select:none}
...
.docier-status{display:flex;grid-area:status;align-items:center;gap:calc(var(--docier-gap) * 2);background:var(--docier-surface-raised);border-top:1px solid var(--docier-border);padding-inline:calc(var(--docier-gap) * 2);min-height:var(--docier-control-height);overflow-x:auto}
