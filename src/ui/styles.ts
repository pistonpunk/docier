...
.docier-chrome-menubar{display:flex;grid-area:menubar;align-items:stretch;flex-wrap:nowrap;background:var(--docier-surface);border-bottom:1px solid var(--docier-border);position:relative;z-index:12}
