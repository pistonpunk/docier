...
export const EN_MESSAGES: MessageCatalogue = {
  ...
  'ui.control.changeCase': 'Change Case',
  'ui.control.caseSentence': 'Sentence case.',
  'ui.control.caseLower': 'lowercase',
  'ui.control.caseUpper': 'UPPERCASE',
  'ui.control.caseCapitalize': 'Capitalize Each Word',
  'ui.control.caseToggle': 'tOGGLE cASE',
  ...
  'ui.orientation.portrait': 'Portrait',
  'ui.orientation.landscape': 'Landscape',
  'ui.pageSize.letter': 'Letter',
  'ui.pageSize.legal': 'Legal',
  'ui.pageSize.a4': 'A4',
  ...
  'ui.pageBorder.box': 'Box',
  'ui.pageBorder.double': 'Double box',
  'ui.pageBorder.thick': 'Thick box',
  'ui.pageBorder.dashed': 'Dashed box',
  'ui.pageBorder.dotted': 'Dotted box',
  'ui.pageBorder.none': 'No border',
  'ui.pageColour.white': 'White',
  'ui.pageColour.cream': 'Cream',
  'ui.pageColour.mint': 'Mint',
  'ui.pageColour.sky': 'Sky',
  'ui.pageColour.blush': 'Blush',
  'ui.pageColour.grey': 'Light grey',
  'ui.pageColour.none': 'No colour',
  'ui.colour.custom': 'Custom Colour',
  ...
  'ui.lineNumbers.none': 'No line numbers',
  'ui.direction.ltr': 'Left-to-right',
  'ui.direction.rtl': 'Right-to-left',
  'ui.columns.one': 'One',
  'ui.columns.two': 'Two',
  'ui.columns.three': 'Three',
  'ui.watermark.draft': 'DRAFT',
  'ui.watermark.confidential': 'CONFIDENTIAL',
  'ui.watermark.sample': 'SAMPLE',
  'ui.watermark.doNotCopy': 'DO NOT COPY',
  'ui.watermark.asap': 'ASAP',
  'ui.watermark.remove': 'Remove watermark',
  'ui.watermark.custom': 'Watermark colour…',
  'ui.pageBorder.colour': 'Border colour',
  'ui.menu.formula': 'Formula',
  'ui.formula.sumAbove': 'SUM of the cells above',
  'ui.formula.sumLeft': 'SUM of the cells to the left',
  'ui.formula.averageAbove': 'AVERAGE of the cells above',
  'ui.formula.countAbove': 'COUNT of the cells above',
  'ui.formula.maxAbove': 'MAX of the cells above',
  'ui.formula.minAbove': 'MIN of the cells above',
  'ui.menu.alignObjects': 'Align',
  'ui.align.left': 'Align Left',
  'ui.align.center': 'Align Center',
  'ui.align.right': 'Align Right',
  'ui.align.top': 'Align Top',
  'ui.align.middle': 'Align Middle',
  'ui.align.bottom': 'Align Bottom',
  'ui.wrap.square': 'Square',
  'ui.wrap.tight': 'Tight',
  'ui.wrap.through': 'Through',
  'ui.wrap.topAndBottom': 'Top and Bottom',
  'ui.wrap.none': 'In Line with Text',
  ...
  'ui.cover.plain': 'Plain',
  'ui.cover.banded': 'Banded',
  'ui.cover.lines': 'Ruled',
  ...
  'ui.menu.themeFonts': 'Theme Fonts',
  'ui.menu.themeColours': 'Theme Colours',
  'ui.menu.paragraphSpacing': 'Paragraph Spacing',
  'ui.themeFont.office': 'Calibri Light / Calibri',
  'ui.themeFont.georgia': 'Georgia / Calibri',
  'ui.themeFont.arial': 'Arial',
  'ui.themeFont.times': 'Times New Roman',
  'ui.themeFont.trebuchet': 'Trebuchet MS',
  'ui.themeFont.verdana': 'Verdana',
  'ui.themeColour.office': 'Office',
  'ui.themeColour.blue': 'Blue',
  'ui.themeColour.green': 'Green',
  'ui.themeColour.warm': 'Warm',
  'ui.themeColour.greyscale': 'Greyscale',
  'ui.themeSpacing.none': 'No Paragraph Space',
  'ui.themeSpacing.compact': 'Compact',
  'ui.themeSpacing.open': 'Open',
  'ui.themeSpacing.relaxed': 'Relaxed',
  ...
  'ui.borders.style': 'Style',
  'ui.borders.width': 'Width',
  'ui.borders.colour': 'Colour',
  'ui.borders.applyTo': 'Apply to',
  'ui.borders.scope': 'Apply to',
  'ui.borders.scopeTable': 'Whole table',
  'ui.borders.scopeCell': 'This cell',
  'ui.borders.fill': 'Shading fill',
  'ui.borders.fillPlaceholder': 'none',
  'ui.table.title': 'Table Properties',
  'ui.table.size': 'Size',
  'ui.table.alignment': 'Alignment',
  'ui.table.width': 'Preferred width',
  'ui.table.layout': 'Layout',
  'ui.table.alignUnchanged': 'Leave unchanged',
  'ui.table.alignLeft': 'Left',
  'ui.table.alignCenter': 'Center',
  'ui.table.alignRight': 'Right',
  'ui.table.layoutUnchanged': 'Leave unchanged',
  'ui.table.layoutAutofit': 'AutoFit to contents',
  'ui.table.layoutFixed': 'Fixed column widths',
  'ui.table.nothingToChange': 'Change something to apply',
