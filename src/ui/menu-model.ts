    ...
    groups: [
      {
        ...
        nodes: [
          ...
          menu('ui.control.orientation', [
            button({
              labelKey: 'ui.orientation.portrait',
              id: 'orientation:portrait',
              command: command('doc.setOrientation'),
              args: { orientation: 'portrait' },
            }),
            button({
              labelKey: 'ui.orientation.landscape',
              id: 'orientation:landscape',
              command: command('doc.setOrientation'),
              args: { orientation: 'landscape' },
            }),
          ]),
          menu('ui.control.pageSize', [
            button({
              labelKey: 'ui.pageSize.letter',
              id: 'pagesize:letter',
              command: command('doc.setPageSize'),
              args: { preset: 'letter' },
            }),
            button({
              labelKey: 'ui.pageSize.legal',
              id: 'pagesize:legal',
              command: command('doc.setPageSize'),
              args: { preset: 'legal' },
            }),
            button({
              labelKey: 'ui.pageSize.a4',
              id: 'pagesize:a4',
              command: command('doc.setPageSize'),
              args: { preset: 'a4' },
            }),
  ...
  groups: [
    ...
    },
    {
      ...
      nodes: [
        ...
        button({
          labelKey: 'ui.menu.bordersShading',
          id: 'table:borders',
          keytip: 'BS',
          action: 'openDialog',
          actionArgs: { dialog: 'borders' },
        }),
      ],
    },
  ],
